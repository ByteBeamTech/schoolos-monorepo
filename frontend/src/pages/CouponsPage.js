  ...
  return (
    <div>
      <div className="mb-8 flex items-start justify-between">
        <div>
          <h1 data-testid="page-title" className="text-2xl font-bold text-white tracking-tight">Coupons</h1>
          ...
          <form onSubmit={create} className="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <div className="md:col-span-5 flex gap-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-slate-800 text-slate-400 text-sm rounded-lg"
              >
                Cancel
              </button>
            </div>
      ...
      <div className="bg-slate-900 rounded-xl border border-slate-800 overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-slate-800/50">
            {coupons.map((c) => (
              <tr key={c.code} data-testid={`coupon-row-${c.code}`} className="hover:bg-slate-800/30">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-16 h-1.5 bg-slate-800 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{ width: `${Math.round((c.uses / c.maxUses) * 100)}%` }}
                        />
                      </div>
