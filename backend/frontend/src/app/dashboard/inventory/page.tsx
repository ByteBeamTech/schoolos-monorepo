  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
        ...
        <StatCard label="Active Issues"  value={issues?.filter((i:any) => i.status === 'ISSUED').length ?? 0} icon={<ArrowUpFromLine className="w-5 h-5"/>} color="yellow" loading={iLoad} />
      </div>
                ...
                {[
                  ...
                  <div key={k}>
                    ...
                    <input
                      ...
                      required={req}
                      value={(obj as any)[k]}
                      onChange={e => (set as any)(p => ({ ...p, [k]: e.target.value }))}
