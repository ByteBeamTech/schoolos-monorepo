...
//
// Apply in prisma.service.ts constructor:
//   super({ datasources: { db: { url: buildDatabaseUrl(config) } } })
...
// }
//
// And add ConfigService to the constructor injection in the module.
