...
export interface FlagDefinition {
  ...
  allowedTiers:       ReadonlyArray<string>; // Fix: use ReadonlyArray<string>, not readonly string[]
...
export const MODULE_FLAGS: FlagDefinition[] = [
  ...
  { name: 'MODULE_STUDENTS', category: 'MODULE', label: 'Students',
    description: 'Student master records and profiles',
    defaultValue: true, allowedTiers: TIER.ALL, tenantControllable: false },
